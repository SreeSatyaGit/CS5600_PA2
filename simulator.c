...
int main(int argc, char **argv) {
	// Sets the value of the global variable scheme. For the time slice rotation (RR) policy, 
	// the length of the time slice (quantum) is also parsed and set.
	FILE *fp;
	...
	// read the arrival time, execution time, and priority of each job
